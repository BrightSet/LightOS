...
//if (sessionStorage.i == 1) {
	...
	document.writeln("<style>*:not(h1){margin:0;}</style><div id='mainBar' style='z-index:5242; margin:0;'><span onclick='location.href=\"index.html\"' ontouchstart='location.href=\"index.html\"'>⌂</span> </div>")
